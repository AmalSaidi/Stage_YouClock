...
@endif
<form action = "/edit/utilisateur/<?php echo $affichage[0]->id; ?>/<?php echo $affichage[0]->idUser; ?>" method = "post">
<input type="hidden" value="<?php echo $affichage[0]->idfiche; ?>" name="idFi">
{!! csrf_field() !!}
<h3 id="titlee">
